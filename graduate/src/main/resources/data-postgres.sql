...
insert into address (street, number, city, lon, lat) values
                    ...
                    ('Sopot', '55', 'Beograd', 20.5744258, 44.5218165),
                    ('Zlatar', '20', 'Nova Varos', 20.5744258, 44.5218165);
insert into household (name, phone_number, registration_number, address_id) values
                      ('Samcovic', '06474738493', '12345678', 1),
                      ('Peric', '0427482842', '12345678', 2),
                      ('Mikic', '0237832323', '12345678', 3);
...
insert into offer (name, description, price, col_for_price, average_rate, household_id, type) values
            ...
            ('Malina domaca', 'Preukusne, krupne..', 300, '1kg', 0, 2, 'Malina'),
            ('Kupina', 'Prelepe', 400, '1kg', 0, 1, 'Kupina'),
            ('Višnje domace', 'Prelepe', 150, '1kg', 0, 1, 'Višnja'),
            ('Jagode', 'Prelepe', 150, '1kg', 0, 1, 'Jagoda'),
            ('Jagode', 'Prelepe', 150, '1kg', 0, 3, 'Jagoda');
